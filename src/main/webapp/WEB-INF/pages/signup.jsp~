    ...
    <form:form commandName="user" method="post" action="signup" id="signupForm" autocomplete="off"
        ...
        <div class="row">
            ...
            <div class="col-sm-6 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
                ...
                <appfuse:label styleClass="control-label" key="user.dateOfBirth"/>
                <form:input cssClass="form-control" path="dateOfBirth" id="email"/>
                <form:errors path="email" cssClass="help-block"/>
            </div>
            <div class="col-sm-6 form-group">
                <appfuse:label styleClass="control-label" key="user.gender"/>
                <form:select cssClass="form-control" path="gender" id="phoneNumber">
        ...
        <div class="row">
            <spring:bind path="user.bloodGroup">
            <div class="col-sm-6 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
            </spring:bind>
                <appfuse:label styleClass="control-label" key="user.bloodGroup"/>
                <form:select cssClass="form-control" path="bloodGroup" id="email">
            ...
            <div class="col-sm-6 form-group">
                <appfuse:label styleClass="control-label" key="user.nationality"/>
                <form:select cssClass="form-control" path="nationality" id="phoneNumber">
        ...
        <div class="form-group">
            <appfuse:label styleClass="control-label" key="user.religion"/>
            <form:select cssClass="form-control" path="religion" id="website">
        ...
        <div>
            ...
            <div id="collapse-address" class="accordion-body collapse">
                ...
                <div class="form-group">
                 ...
                 <form:input type = "hidden" path = "roleId" value="1"/> 
            </div>
        </div>
        <div class="form-group">
