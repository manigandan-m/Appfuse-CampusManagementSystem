...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody>
                    ...
                    <tr><td>Email:</td><td><c:out value="${searchTeacher.getUser().getEmail()}"/></td></tr>
                    <tr><td>Phone Number:</td><td><c:out value="${searchTeacher.getUser().getPhoneNumber()}"/></td></tr>
                    <tr><td>Website:</td><td><c:out value="${searchTeacher.getUser().getWebsite()}"/></td></tr>
