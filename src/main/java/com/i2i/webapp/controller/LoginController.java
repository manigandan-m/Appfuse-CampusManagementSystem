...
public class LoginController {
    ...
    public String teacherLoginCheck(@RequestParam("username") String username, @RequestParam("password") String password,
        HttpSession session, ModelMap map) throws  IOException, ServletException {
        try {
            User user = userService.getUserByUsername(username);
            if (password.equals(user.getPassword()) ) {
    ...
    public String studentLoginCheck(@RequestParam("username") String username, @RequestParam("password") String password,
        HttpSession session, ModelMap map) throws  IOException, ServletException {
        try {
            User user = userService.getUserByUsername(username);
            if (password.equals(user.getPassword()) ) {
