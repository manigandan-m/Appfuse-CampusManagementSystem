...
public class PeriodSubjectDetailController {
    private PeriodSubjectDetailService periodSubjectDetailService;
    private StandardService standardService;
    private SubjectService subjectService;
    private TeacherService teacherService;
    
    @Autowired
    public void setPeriodSubjectDetailService(PeriodSubjectDetailService periodSubjectDetailService) {
        this.periodSubjectDetailService = periodSubjectDetailService;
    }
